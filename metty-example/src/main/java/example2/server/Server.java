...
import io.metty.codec.others.StringDecoder;
    ...
    public static void main(String[] args) {
        ...
        serverBootstrap.group(bossGroup,workkerGroup).bind(8081).channel(NioServerSocketChannel.class).
            ...
            public void initChannel(NioSocketChannel nioSocketChannel) throws Exception {
                nioSocketChannel.pipeline().addLast(new LineBasedFrameDecoder());
                nioSocketChannel.pipeline().addLast(new StringDecoder("UTF-8"));
